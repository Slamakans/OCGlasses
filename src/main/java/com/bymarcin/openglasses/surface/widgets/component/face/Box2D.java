...
public class Box2D extends WidgetGLOverlay {
	...
	public class RenderableBox2DWidget extends RenderableGLWidget{
		...
		public void createGradient(VertexBuffer buff, float[] col1, float[] col2, float[] col3, float[] col4){
		...
		public void drawUVMappedRect(VertexBuffer buff, float minU, float maxU, float minV, float maxV) {
